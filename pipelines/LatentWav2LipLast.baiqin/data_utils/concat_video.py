...
video_list=['experiments/all_resume/checkpoint/example1_english.mp4','experiments/all_test1/checkpoint/example1_english_acc.mp4']
audio_file='data/audio/english.wav' 
tmp_path='results/tmp.mp4'
output_path='results/concat_example3.mp4'
rows=1
cols=2
