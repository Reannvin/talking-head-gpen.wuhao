    ...
    with open('filelists/{}.txt'.format(split)) as f:
        for line in f:
            ...
            if ' ' in line:
                ...
                filelist.append(os.path.join(data_root, 'images',filename))
...
class Dataset(object):
    ...
    def __getitem__(self, idx):
        while 1:
            ...
            # else:
            #     continue
            audio_feature = np.load(os.path.join(self.whisper_path, sub_folder_name, str(window_index) + ".npy"))
