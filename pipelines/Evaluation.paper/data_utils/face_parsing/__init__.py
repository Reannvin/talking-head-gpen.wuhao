...
class FaceParsing():
    ...
    def model_init(self, 
                   resnet_path='/data/shenfan/workspace/talking-head/pipelines/LatentWav2Lip.OnTheFly/resnet18-5c106cde.pth', 
                   model_pth='/data/shenfan/workspace/talking-head/pipelines/LatentWav2Lip.OnTheFly/79999_iter.pth'):
