...
def main():
    ...
    # parser.add_argument('--model_path', type=str, default='experiments/BasicVS_vfhq_VFR/models/net_g_75000.pth')
    parser.add_argument('--model_path', type=str, default='experiments/BasicVS_vfhq_VFR_perce/models/net_g_5000.pth')
    parser.add_argument(
        # '--input_path', type=str, default='datasets/REDS4/sharp_bicubic/000', help='input test image folder')
        # '--input_path', type=str, default='/data2/weijinghuan/superRestoration/GFPGAN/results/test_liuwei1_512/', help='input test image folder')
        '--input_path', type=str, default='/data2/weijinghuan/head_talk/MuseTalk/results/lisha_30s25fps16k1ch_crop_guoguo_30s25fps16k1ch_crop_512/', help='input test image folder')
    parser.add_argument('--save_path', type=str, default='results/BasicVSRPP/lisha_perce_5k', help='save image path')
