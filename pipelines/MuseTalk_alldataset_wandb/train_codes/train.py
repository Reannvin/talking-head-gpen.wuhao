...
def main():
    ...
    accelerator = Accelerator(
        ...
        log_with="tensorboard" if  not args.wandb else "wandb",
...
#         set_seed(args.seed)
    ...
    vae = AutoencoderKL.from_pretrained('stabilityai/sd-vae-ft-mse', local_files_only=True)
    vae_fp32 = AutoencoderKL.from_pretrained('stabilityai/sd-vae-ft-mse', local_files_only=True)
    ...
    train_dataset = Dataset(args.data_root, args.audio_root,
                            'train', 
    ...
    val_dataset = Dataset(args.data_root,args.audio_root,
                          'val', 
                          use_audio_length_left=args.use_audio_length_left,
                          use_audio_length_right=args.use_audio_length_right,
                          whisper_model_type=args.whisper_model_type
    ...
    if accelerator.is_main_process and args.wandb: 
        accelerator.init_trackers(
            ...
            init_kwargs={"wandb": {"entity": "local-optima"}},
            config=vars(args)
        )
    else:
