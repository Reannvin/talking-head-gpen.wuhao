...
def g_image_recon_loss(real_image, fake_image):
...
#     g_loss_l1 = smooth_l1_loss(fake_img, real_img)
    
#     g_lpips_loss, __, __ = id_loss(fake_img, real_img, input_img)
...
#     # 1:10000:1
#     # 1:10:1
#     g_loss = g_loss_l1 + g_lpips_loss + adaptive_weight * gen_loss

#     return g_loss, g_loss_l1, g_lpips_loss, adaptive_weight, gen_loss
...
def train(args, loader, generator, discriminator, losses, g_optim, d_optim, g_ema, lpips_func, device):
    ...
    for idx in pbar:
        ...
        # TODO
        # g_loss, g_loss_l1, g_lpips_loss, adaptive_weight, gen_loss = g_nonsaturating_loss(fake_pred, losses, fake_img, real_img)
        ...
        g_loss = g_recon_loss + g_lpips_loss + adaptive_weight * gen_loss
...
if __name__ == '__main__':
    ...
    if args.stage_1_pt is not None:
        print('load model:', args.stage_1_pt)
    ...
    lpips_func = lpips.LPIPS(net='vgg',version='0.1').to(device)
    ...
    dataset = AudioVisualDataset(data_root = args.data_root, dataset_name = args.dataset_name, split = 'main')
